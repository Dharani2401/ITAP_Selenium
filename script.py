...
try:
    ...
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\json\\3\\page2.png')
    ...
    classname_list.append(element.get_attribute("className"))
    text_list.append(element.text)
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\json\\3\\page3.png')
    ...
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\json\\3\\page4.png')
    ...
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\json\\3\\page5.png')
    ...
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\json\\3\\page6.png')
    ...
    classname_list.append(element.get_attribute("className"))
    text_list.append(element.text)
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\json\\3\\page7.png')
    ...
    with open("D:\iTAP\Recorded_Scenarios\\json\\3\\logfile.log", "w+") as external_file:
    ...
    total = finish_time - start_time
    total=str(total).split(".")[0]
    path = open("D:\iTAP\Recorded_Scenarios\\json\\3\\logfile.log", 'w+')
