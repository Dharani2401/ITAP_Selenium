...
try:
    ...
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\recordernew\\1_data2\\page1.png')
        ...
        try:
            ...
            break
             ...
             if len(possible_xpaths)-1 == idx:
                ...
                raise Exception('Element Not Found')
    driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\recordernew\\1_data2\\page2.png')
    ...
    for idx,i in enumerate(possible_xpaths):
        try:
            element = WebDriverWait(driver, delay).until(EC.element_to_be_clickable((By.XPATH, i)))
            driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\recordernew\\1_data2\\page3.png')
    ...
    for idx,i in enumerate(possible_xpaths):
        try:
            element = WebDriverWait(driver, delay).until(EC.element_to_be_clickable((By.XPATH, i)))
            driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\recordernew\\1_data2\\page4.png')
            output[i] = element.text
            actions = ActionChains(driver)
            actions.move_to_element(element).perform()
            try:
    ...
    for idx,i in enumerate(possible_xpaths):
        try:
            element = WebDriverWait(driver, delay).until(EC.element_to_be_clickable((By.XPATH, i)))
            driver.save_screenshot('D:\iTAP\Recorded_Scenarios\\recordernew\\1_data2\\page5.png')
            output[i] = element.text
            actions = ActionChains(driver)
            actions.move_to_element(element).perform()
            try:
    ...
    with open("D:\iTAP\Recorded_Scenarios\\recordernew\\1_data2\\logfile.log", "w+") as external_file:
